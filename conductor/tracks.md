...
| :--- | :--- | :--- | :--- |
| `03-ux-polish-bug-fixes` | Currency masks and deletion feedback. | Spec Approved | [Track Folder](./tracks/03-ux-polish-bug-fixes/) |

## Planned Tracks
| Track ID | Description | Priority |
| :--- | :--- | :--- |
| `04-custom-categories` | Screen to create, edit, or delete categories linked to groups. | High |
